...
const Titel = () => (
  <nav className="flex justify-between items-center sm:px-10 px-4 py-6">
    <a href="/">
      <svg
        height="40"
    ...
    <div className="nav-links">
      <ul className="flex gap-7 font-san">
        <li className="sm:block hidden">
          <a href="#" className="text-xl hover:text-amber-500">
            Home
          </a>
        </li>
        <li className="sm:block hidden">
        ...
        <li>
          <a href="#" className="text-xl text-amber-500 hover:text-amber-600">
            Cart +
          </a>
        </li>
      </ul>
...
const Cart = ({
  ...
  <div className=" sm:px-10 py-10 px-4 hover:bg-slate-100">
    <div className="sm:w-72 w-60">
      <img
        ...
        alt="food"
      />
      <h1 className="text-3xl px-1 pb-1">{name}</h1>
      <h2 className="text-xl px-1 pb-1">{cuisines.join(", ")}</h2>
      <h3 className="px-1 pb-1">📍 {slugs.city}</h3>
      <div className="flex justify-between items-center px-1 py-2">
        <div className="bg-lime-500 px-2 py-1 rounded-md">
          <h3 className="text-sm">{avgRating}⭐</h3>
        </div>
        <h3 className="text-sm">{lastMileTravelString}</h3>
        <h3 className="text-sm">Pay {costForTwoString}</h3>
      </div>
    </div>
  </div>
);
  ...
  return (
    <div className="flex flex-wrap justify-center">
      {restaurantList.map((restaurant) => {
        return <Cart {...restaurant.data} key={restaurant.data.id} />;
      })}
    </div>
  );
};
...
const Foooter = () => (
  <div className="w-auto h-4 bg-amber-300 rounded-t-full"></div>
);
